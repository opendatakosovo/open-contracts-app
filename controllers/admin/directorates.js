...
router.post('/people-in-charge', passport.authenticate('jwt', { session: false }), (req,res) => {
...
router.get('/by-name/:name', passport.authenticate('jwt', { session: false }), (req,res) => {
...
router.put('/deactivate-directorate/:id', passport.authenticate('jwt', { session: false }), (req,res) => {
...
router.put('/activate-directorate/:id', passport.authenticate('jwt', { session: false }), (req,res) => {
    const directorateID = req.params.id;
