...
const ContractSchema = mongoose.Schema({
    ...
    releases: [{
        ...
        contracts: [{
            ...
            implementation: {
                ...
                finalValueDetails: {
                    type: String,
                    default: 'The total amount of the contract payed'
                }
            },
            amendments: [{
                date: {
    ...
    publisher: {
        ...
        uri: {
            type: String,
            default: 'http://opendatakosovo.org'
        }
    },
    activityTitle: {
        type: String
    ...
    noOfCompaniesWhoDownloadedTenderDoc: {
        type: Number
    },
    noOfCompaniesWhoSubmited: {
        type: Number
    },
    ...
    publicationDateOfGivenContract: {
        type: Date
    },
...
module.exports.getContractsByDirectorate = directorateName => {
    return Contract.find({
        "releases.buyer.name": directorateName
    });
}
...
module.exports.getContractsByContractorCompany = companyName => {
    return Contract.find({
        "releases.tender.tenderers.name": companyName
    });
}
...
module.exports.getContractsByDirectorateForVisualizations = (directorateName, year) => {
...
module.exports.getTotalContractsbyFlagStatus = flagStatus => Contract.find({
    "releases.contracts.status": flagStatus
}).count();
...
module.exports.getContractsByDirectorateForVisualizations = (directorate, year) => {
    let queryArray = [];
    if (directorate == 'Arsim') {
        education.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Administratë') {
        administration.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Infrastrukturë') {
        infrastructure.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Investime') {
        investment.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Kulturë') {
        culture.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Shërbime Publike') {
        publicServices.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Shëndetësi') {
        health.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Kadastrës') {
        cadastre.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Mirëqenia Sociale') {
        socialWelfare.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Bujqësisë') {
        agriculture.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Financave') {
        fincances.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Prona') {
        property.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Urbanizmi') {
        urbanism.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Inspeksioni') {
        inspection.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Planifikimi') {
        planning.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'Parqeve') {
        parks.forEach(element => {
            queryArray.push(element);
        });
    }
    if (directorate == 'E pacaktuar') {
        queryArray.push('');
    }
    array = [];
    array.push({
    ...
    return Contract.aggregate(array);
}
